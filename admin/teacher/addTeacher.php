...
<body>
        ...
        if (isset($_POST['submitSave'])) {
            ...
            if (
                ...
                if (mysqli_num_rows($result2) == 0) {
                    $sql = "INSERT INTO teacher (name, email, password, phone, image) VALUES ('$name', '$email', '$password', '$phone', '$image');";
    ...
    ?>
    <h1 class="text">Admin - Home - Add Teacher</h1>
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class="admin-add-teacher" enctype="multipart/form-data">
        ...
        <input type="text" name="phone" id="phone" placeholder="Enter teacher Phone...">
        <br>
        <label for="password">Password: </label>
        <input type="text" name="password" id="password" placeholder="Enter teacher Password...">
        <br>
