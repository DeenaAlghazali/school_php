...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        if (isset($_REQUEST['submitEdit'])) {
            ...
            if (
                ...
                $sql = "UPDATE student SET name ='" . $name . "', email='" . $email . "', phone='" . $phone . "', password ='" . $password . "', image = '" . $imageURL . "' WHERE id = $id ";
    ...
    <form action="<?php $_SERVER['PHP_SELF'] . "?id=" . $_GET['id'] ?>" method="POST" class="admin-add-teacher">
